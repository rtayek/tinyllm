...
Run contents are experimental outputs and are ignored by Git because
checkpoints and repeated artifacts can become large. Promote intentionally
retained inference artifacts to `models/`.
